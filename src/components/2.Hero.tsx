...
const HeroComponent: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile clouds (absolute, pointer-events none) */}
      <div
        className="sm:hidden"
        style={{ position: "absolute", inset: 0, width: "100vw", height: "100%", zIndex: 0, pointerEvents: "none" }}
        aria-hidden="true"
      >
        <motion.picture initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2, delay: 0.2 }}>
        ...
        <motion.picture initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2, delay: 0.5 }}>
          <source srcSet={cloudWebp} type="image/webp" />
      ...
      >
        ...
        >
          ...
          <motion.p className="mt-4 sm:mt-8 text-md md:text-lg font-semibold italic text-gray-700" initial={v.p1Initial} animate={v.p1Animate} transition={t.p1}>
            Know your cycle. Own your rhythm.
          </motion.p>

          <motion.p className="mt-2 sm:mt-3 text-sm md:text-base text-gray-600 max-w-xl mx-auto" initial={v.p2Initial} animate={v.p2Animate} transition={t.p2}>
