...
/* bring in the same circle to continue the background seamlessly */
...
const testimonialsData: Testimonial[] = [
  {
    ...
    rating: 5,
    text:
      "I never thought I'd find an app that actually understands the struggles women face every month. The insights and goal reminders feel like they were made just for me. Thank you, Aangan!",
    name: "Zainab G.",
    location: "Lahore",
    image: person1,
  },
  {
    ...
    rating: 5,
    text:
      "The doctor chat feature was a lifesaver. I got real answers without the stress of having to leave home. This is the kind of support we need more of.",
    name: "Fatima A.",
    location: "Karachi",
    image: person2,
  },
  {
    ...
    rating: 4,
    text:
      "I've struggled with PCOS for years, but Aangan made it easier to understand my irregular spot patterns. The dashboard is clean, and the AI agent actually helped me feel heard.",
    name: "Meher S.",
    location: "Karachi",
    image: person3,
  },
  {
    ...
    rating: 4,
    text:
      "Cycle predictions are finally accurate for me. The reminders are gentle, not spammy, and the tone feels culturally respectful. Love the small, thoughtful touches.",
    name: "Areeba K.",
    location: "Multan",
    image: person4,
  },
  {
    ...
    rating: 5,
    text:
      "As a working mother, I barely have time for myself. Aangan's period tracking and health reminders have become my personal assistant. It's like having a health coach in my pocket!",
    name: "Sana M.",
    location: "Islamabad",
    image: person5,
  },
  {
    ...
    rating: 4,
    text:
      "The symptom tracker helped me identify patterns I never noticed before. Now I can prepare for my period days and manage my energy better. Truly life-changing!",
    name: "Ayesha R.",
    location: "Faisalabad",
    image: person6,
  },
  {
    ...
    rating: 5,
    text:
      "I love how the app respects our cultural values while providing modern health solutions. The privacy features give me peace of mind, and the insights are incredibly accurate.",
    name: "Mariam T.",
    location: "Peshawar",
    image: person1,
  },
...
const TestimonialCard = React.memo(function TestimonialCard({
  ...
  const baseHover = isDesktop
    ? "group hover:scale-105 hover:-translate-y-2 hover:z-30"
    : "group";
  ...
  return (
    <motion.div
      className={`${baseHover} flex-shrink-0 transition-transform duration-300 will-change-transform`}
      style={widthStyle}
    ...
    >
      <Card
        className={twMerge(
          "relative bg-white/95 rounded-[26px] md:rounded-[28px] lg:rounded-[30px] !border-0 shadow-none transform-gpu [backface-visibility:hidden] will-change-transform cursor-pointer transition-[opacity,transform] ease-in",
          isDesktop
            ? "group-hover:!opacity-100 group-hover:bg-white/80 group-hover:shadow-[inset_2px_2px_16px_#fddde5,inset_-2px_-2px_16px_#fee2e1,0_8px_16px_rgba(0,0,0,0.08)] group-hover:[filter:drop-shadow(0_8px_16px_rgba(0,0,0,0.08))]"
            : ""
        )}
        style={{
          ...widthStyle,
...
const Testimonials: React.FC = () => {
  ...
  return (
    ...
    >
      {/* CONTINUATION OF BACKGROUND CIRCLE (no padding changes) */}
      <img
      ...
      >
        ...
        >
          {/* first set */}
          <div ref={firstSetRef} className="flex flex-nowrap gap-6">
            {testimonials.map((t, idx) => (
              <div key={`d1-${t.id}`} style={{ width: DESKTOP_CARD_WIDTH }}>
                <TestimonialCard t={t} idx={idx} animated variant="desktop" />
              </div>
            ))}
          </div>
          ...
          <div className="flex flex-nowrap gap-6">
            {testimonials.map((t) => (
              <div key={`d2-${t.id}`} style={{ width: DESKTOP_CARD_WIDTH }}>
                <TestimonialCard t={t} idx={0} variant="desktop" />
              </div>
            ))}
          </div>
        </div>
